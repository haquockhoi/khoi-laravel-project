...
<html lang="en">
    ...
    @enderror
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group auth-pass-inputgroup"><input type="password"
       class="form-control"
       name="password"
       ...
       required>
                                            ...
                                            <div class="mt-5 text-center">
                                                <p>Don't have an account ? <a href="{{ url('/custom-register') }}" class="fw-medium text-primary"> Signup now </a> </p>
                                            </div>
                                        </div>
                                    </div>
