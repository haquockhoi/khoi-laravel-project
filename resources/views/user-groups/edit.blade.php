    ...
    <div class="col-lg-7">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('user-groups.update', $userGroup) }}" method="POST" id="user-group-edit-form">
                    @csrf
                    @method('PUT')
...
<script>
    const form = document.getElementById('user-group-edit-form');
    ...
    form.addEventListener('submit', function (event) {
        ...
        .catch(function (error) {
            if (error.errors) {
                ...
                Swal.fire({
                    title: 'Lỗi!',
                    text: 'Không thể cập nhật nhóm user. Vui lòng thử lại.',
                    icon: 'error',
                    width: '360px'
                });
            }
